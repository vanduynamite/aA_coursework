class CatRentalRequestsController < ApplicationController
  before_action :ensure_owner, only: %i(approve deny)
  ...
  def new
    ...
    @rental_request.cat_id = flash[:current_cat_id]
  end
  ...
  def ensure_owner
    unless current_cat.owner == current_user
      flash[:errors] = ["You do not have permission to modify this reservation!"]
