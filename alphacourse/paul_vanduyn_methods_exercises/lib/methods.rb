...
def dec_remainder_of_two_integers(i_dividend, i_divisor)
  (i_dividend.to_f / i_divisor.to_f) % 1
end
...
def int_remainder_without_modulo(i_dividend, i_divisor)
  ...
  (((i_dividend.to_f / i_divisor.to_f) - (i_dividend.to_f / i_divisor.to_f).to_i) * i_divisor).round

  # just some fun
  #
  # if i_dividend < i_divisor
  #   return i_dividend
  # else
  #   return int_remainder_without_modulo(i_dividend - i_divisor, i_divisor)
  # end
end
